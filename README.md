...
| `/grammar` | 510 упражнений по 80+ темам, **до C1**: все ключевые времена, артикли, модальные, условные (всех типов), пассив, фразовые глаголы, инверсия, cleft sentences, mandative subjunctive, formal expressions и т.д. |
...
└── default-exercises.json  510 упражнений по 80+ темам, A1–C1
```
