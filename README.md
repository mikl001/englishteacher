...
| `/reading` | 120 текстов A1–B1. Клик по любому слову → popover с переводом, добавление в словарь одной кнопкой. |
| `/grammar` | 400 упражнений по 60+ темам: все ключевые времена, артикли, модальные, условные (всех типов), пассив, фразовые глаголы, относительные предложения, согласование, herundive/инфинитив, косвенная речь и т.д. |
| `/dictionary` | 1200 слов по 70+ темам с фильтрами и поиском. Можно добавлять свои. |
...
data/
├── default-words.json      1200 слов по 70+ темам
├── default-texts.json      120 текстов с тегом уровня
└── default-exercises.json  400 упражнений по 60+ темам
```
